...
import { MarqueModalComponent } from './marque-modal/marque-modal.component';
...
@Component({
  ...
  styleUrls: ['./marque.component.scss','../../../../../assets/custom-style.css'],
...
export class MarqueComponent implements OnInit {
  ...
  onCreateData(data?) {
   ...
   let dialogRef= this.dialogService.open(MarqueModalComponent, {
      context: {
        title: data,
  ...
  deleteItem(data){
    ...
    console.log('data sent to server',JSON.stringify(request));
    this.spinner.show();
    this.restClient.execute('marque','delete',request).subscribe(
      (res:any)=>{
        this.spinner.hide();
