...
@Component({
  selector: 'ngx-status-modal',
  templateUrl: './status-modal.component.html',
  styleUrls: ['./status-modal.component.scss','../../../../../../assets/custom-style.css']
})
export class StatusModalComponent implements OnInit {
  ...
  itemToSave:any = {};
  userData:any
  constructor(protected ref: NbDialogRef<StatusModalComponent>,private dialogService: NbDialogService,
  ...
  saveItem(data){
    ...
    this.spinner.show()
    this.restClient.execute('statut',data.id?'update':'create',request).subscribe(
      (res:any)=>{
        console.log('res',res);
        this.spinner.hide()
        if(res && !res.hasError){
